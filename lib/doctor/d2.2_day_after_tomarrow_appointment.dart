...
class DayAfterTomorrowAppointments extends StatefulWidget {
  @override
  _DayAfterTomorrowAppointmentsState createState() =>
      _DayAfterTomorrowAppointmentsState();
}

class _DayAfterTomorrowAppointmentsState
    extends State<DayAfterTomorrowAppointments> {
  @override
          ...
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            for (var userDoc in userDocs) {
              ...
              if (userData.containsKey('appointments')) {
                ...
                appointment['date'] == formattedDayAfterTomorrow).toList();
