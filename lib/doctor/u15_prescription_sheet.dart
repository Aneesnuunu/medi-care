...
//   final String place;
//   final String date;
//   final String appointmentId; // Add the appointmentId parameter
//
//   const PrescriptionSheet({
//     super.key,
//     required this.name,
...
//     required this.place,
//     required this.date,
//     required this.appointmentId, // Initialize the appointmentId parameter
//   });
//
//   @override
//   State<PrescriptionSheet> createState() => _PrescriptionSheetState();
...
class _PrescriptionSheetState extends State<PrescriptionSheet> {
  ...
  Future<void> _captureAndUploadScreenshot() async {
    setState(() {
      _isUploading = true; // Set uploading state to true when button is pressed
    });
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Screenshot stored successfully')),
      );
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
      ...
      setState(() {
        _isUploading =
            false; // Set uploading state to false when operation completes
      });
    }
  }
          ...
          floatingActionButton: Padding(
            ...
            child: _isUploading
                ...
                : SizedBox(
                    ...
                    height: 50,
                    child: ElevatedButton(
                      onPressed: _captureAndUploadScreenshot,
                      style: ElevatedButton.styleFrom(
                        shape: RoundedRectangleBorder(
                          borderRadius: BorderRadius.circular(11),
                        ),
